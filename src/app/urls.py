...
urlpatterns = [
    ...
    #re_path(r'^request/confirm/(?P<ridb64>[0-9]{10})/(?P<token>[0-9]{10})/$', views.confirmRequest1, name = 'confirmRequest1'),
    #re_path(r'^request/confirm/(?P<ridb64>[0-9]{10})/(?P<token>[0-9]{10})/$', views.confirmRequest2, name = 'confirmRequest2'),
    #re_path(r'^request/confirm/(?P<id>[0-9]{10})/$', views.checkStatus, name = 'check status'),
